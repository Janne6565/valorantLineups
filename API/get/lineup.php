...
$sql = "SELECT Lineups.ID, Lineups.UserId, Approved, AbilityId, DateCreated, ImageLineup, FromSpotId, ToSpotId, Users.Username FROM Lineups, Users WHERE Users.ID = Lineups.UserId AND Lineups.ID = ?";
